function Card() {
  return (
    <section className="max-w-5xl bg-white rounded-xl mt-5 px-8 py-12 shadow-lg dark:bg-darkLighterDarkBlue desktop:px-24 desktop:py-14 tablet:px-20">
      <section className="flex flex-row items-center space-x-6 tablet:space-x-12 desktop:space-x-8">
        ...
        <div className="flex flex-col space-y-0.5 tablet:space-y-1.5 desktop:justify-between desktop:flex-row desktop:space-x-40">
          <div>
            ...
            <h3 className="text-blue text-13 tablet:text-16">@octocat</h3>
          </div>
      ...
      {/* Github Bio */}
      <p className="text-grayishBlue mt-10 leading-25 dark:text-white tablet:text-15 desktop:ml-[150px] desktop:-mt-4">
      ...
      <section className="bg-lightGrayishBlue dark:bg-darkDarkBlue flex justify-center space-x-6 py-4 px-5 rounded-xl mt-6 tablet:space-x-12 desktop:ml-[150px]">
        <div className="flex flex-col justify-center items-center tablet:space-y-1">
          <p className="text-grayishBlue text-13 dark:text-white">Repos</p>
          <p className="font-bold text-16 dark:text-white tablet:text-22">8</p>
        </div>
        <div className="flex flex-col justify-center items-center tablet:space-y-1">
        ...
        <div className="flex flex-col justify-center items-center text-left tablet:space-y-1">
          <p className="text-grayishBlue text-13 dark:text-white ">Following</p>
          <p className="font-bold text-16 dark:text-white tablet:text-22">9</p>
        </div>
      </section>
      ...
      <section className="grid grid-cols-1 mt-7 tablet:grid-cols-2 tablet:space-y-0 gap-4 desktop:ml-[150px]">
        {/* Location */}
        <section className="flex flex-row items-center space-x-4 order-1">
          ...
          <p className="text-grayishBlue dark:text-white">San Francisco</p>
        </section>

        {/* Website */}
        <section className="flex flex-row items-center space-x-4 order-2">
          <svg height="20" width="20" xmlns="http://www.w3.org/2000/svg">
        ...
        {/* Twitter */}
        <section className="flex flex-row items-center space-x-4 order-3 tablet:order-1">
          <svg height="20" width="20" xmlns="http://www.w3.org/2000/svg">
            <path
          ...
          <p className="text-grayishBlue dark:text-white">Not Available</p>
        </section>

        {/* Location */}
        <section className="flex flex-row items-center space-x-4 order-4">
          <svg height="20" width="20" xmlns="http://www.w3.org/2000/svg">
            <g fill="#4b6a9b" className="dark:fill-white">
          ...
          <p className="text-grayishBlue dark:text-white">@github</p>
        </section>
      </section>
    </section>
  );
