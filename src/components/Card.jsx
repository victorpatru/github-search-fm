function Card() {
  return (
    <section className="max-w-xl bg-white rounded-xl mt-5 p-6">
      <section className="flex flex-row items-center space-x-10">
        ...
        {/* Github Information */}
        <div>
          <h2 className="text-[16px] lg:text-base -mb-1">The Octocat</h2>
          <h3 className="text-blue text-[13px] lg:text-base">@octocat</h3>
          <h4 className="text-[13px] lg:text-base text-grayishBlue">
            Joined 25 Jan 2011
          </h4>
        </div>
      </section>
      ...
      <section className="bg-lightGrayishBlue flex justify-center space-x-10 p-5 rounded-xl mt-6">
        <div className="flex flex-col justify-center items-center">
          <p className="text-grayishBlue">Repos</p>
          <span className="font-bold text-monospace text-[16px]">8</span>
        </div>
        <div className="flex flex-col justify-center items-center">
          <p className="text-grayishBlue">Followers</p>
          <span className="font-bold text-monospace text-[16px]">3938</span>
        </div>
        <div className="flex flex-col justify-center items-center">
          <p className="text-grayishBlue">Following</p>
          <span className="font-bold text-monospace text-[16px]">9</span>
        </div>
      </section>

      {/* Github Social Links */}
      <section className="grid grid-cols-1 mt-6 space-y-3 md:grid-cols-2">
        {/* Location */}
        <section className="flex flex-row items-center space-x-4">
          ...
          <p className="text-grayishBlue">San Francisco</p>
        </section>
        ...
        <section className="flex flex-row items-center space-x-4">
          ...
          <p className="text-grayishBlue">https://github.blog</p>
        </section>
        ...
        <section className="flex flex-row items-center space-x-4">
          ...
          <p className="text-grayishBlue">Not Available</p>
        </section>
        ...
        <section className="flex flex-row items-center space-x-4">
          ...
          <p className="text-grayishBlue">@github</p>
        </section>
      </section>
    </section>
  );
